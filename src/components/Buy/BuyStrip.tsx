      ...
      <div className="mx-auto max-w-screen-xl px-3 sm:px-4 md:px-6 py-4 sm:py-5">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3">
            <a href="https://www.bybit.com/en/trade/spot/MCRT/USDT" target="_blank" rel="noreferrer noopener" className="btn-primary">Buy on Bybit</a>
            <a href="https://pancakeswap.finance/swap?outputCurrency=0x4b8285aB433D8f69CB48d5Ad62b415ed1a221e4f" target="_blank" rel="noreferrer noopener" className="btn-secondary">Buy on PancakeSwap</a>
            <button onClick={() => navigator.clipboard.writeText('0x4b8285aB433D8f69CB48d5Ad62b415ed1a221e4f')} className="px-3 py-2 rounded-lg bg-white/10 border border-white/15 hover:bg-white/15 text-white text-sm">Copy Contract</button>
          </div>
        </div>
      </div>
    </section>
