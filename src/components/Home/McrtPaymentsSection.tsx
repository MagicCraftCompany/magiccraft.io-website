...
const MCRTPAY_SNIPPET = `<script src="https://mcrtpay.com/js/mcrtpay.js"></script>
...
export default function McrtPaymentsSection() {
  return (
    <section
      id="mcrt-payments"
      className="w-full border-t border-white/5 bg-gradient-to-b from-[#03082f] via-[#0a0524] to-[#03082f]"
    >
      <div className="mx-auto max-w-screen-xl px-3 py-6 sm:px-4 sm:py-8 md:px-6">
        {/* Main payments card */}
        <div className="card-glass rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-5 shadow-[0_0_30px_rgba(152,255,249,0.1)] backdrop-blur-sm sm:px-6 sm:py-7 md:px-8">
          <div className="flex flex-col items-center justify-between gap-5 md:gap-6 lg:flex-row lg:items-start">
            <div className="max-w-3xl text-center lg:text-left">
              ...
              <h3 className="bg-gradient-to-r from-[#98FFF9] via-[#B591F2] to-[#FFB649] bg-clip-text font-serif text-2xl font-bold text-transparent sm:text-3xl md:text-4xl">
                Payments for Players, Builders, and AI Products
              </h3>
              <p className="mt-3 text-sm leading-relaxed text-white/80 sm:text-base">
                $MCRT gives the MagicCraft ecosystem a single settlement layer
                for lobby entry, player-to-player value, NFT commerce, builder
                tools, creator payouts, and AI-driven experiences. It keeps the
                story simple: play, own, build, and transact with the same
                token.
              </p>
            </div>
            <div className="flex flex-wrap items-center justify-center gap-2 text-[11px] sm:gap-3 sm:text-xs lg:justify-end">
              <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-2.5 py-1 text-white/80">
                <svg
                  ...
                  aria-hidden="true"
                >
                  <path d="M12 4a8 8 0 1 1-7.938 7H5a7 7 0 1 0 2.05-4.95l1.414 1.415A5 5 0 1 1 17 12h2A7 7 0 0 0 12 4Zm.5 4a1 1 0 0 0-1 1v3.586l-2.207 2.207a1 1 0 1 0 1.414 1.414l2.5-2.5A1 1 0 0 0 13.5 13V9a1 1 0 0 0-1-1Z" />
                </svg>
              ...
              <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-2.5 py-1 text-white/80">
                <svg
                  ...
                  aria-hidden="true"
                >
                  <path d="M7 7a3 3 0 1 1 0 6 3 3 0 0 1 0-6Zm10 0a3 3 0 1 1 0 6 3 3 0 0 1 0-6ZM5 17a4 4 0 0 1 4-4h6a4 4 0 0 1 4 4v1H5v-1Z" />
                </svg>
          ...
          <div className="mt-4 flex items-center justify-center gap-3 lg:justify-start">
            ...
            <Link to="/build-on-magiccraft" className="btn-secondary">
              Learn more
            </Link>
          </div>
        </div>
        ...
        <div className="mt-4 overflow-hidden rounded-2xl border border-[#f0b90b]/25 bg-gradient-to-br from-[#f0b90b]/[0.06] via-[#03082f]/80 to-[#0a0524]/90 shadow-[0_0_40px_rgba(240,185,11,0.08)] backdrop-blur-sm">
          <div
            className="h-px w-full bg-gradient-to-r from-transparent via-[#f0b90b]/40 to-transparent"
            aria-hidden="true"
          />
          <div className="px-4 py-5 sm:px-6 sm:py-7 md:px-8">
              ...
              <div className="flex min-w-0 flex-1 flex-col gap-4 sm:flex-row sm:gap-5">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-2 max-w-2xl text-xs leading-relaxed text-white/65 sm:text-sm">
                    Drop-in widget and TypeScript-friendly flows. On-chain
                    BscScan verification. Works with any stack: vanilla JS,
                    Next.js, React, or Node. Add $MCRT payments to your app in
                    minutes.
                  </p>
                  <div className="mt-4 rounded-xl border border-white/10 bg-black/40 p-3 shadow-inner sm:p-4">
