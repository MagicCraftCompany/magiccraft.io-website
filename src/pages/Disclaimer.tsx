  ...
  return (
    <div className="min-h-dvh w-full text-white">
      <Helmet>
        ...
        <meta
          name="description"
          content="MagicCraft Disclaimer. Important information about risks, legal obligations, and limitations when using MagicCraft services."
        />
        <meta
          name="keywords"
          content="MagicCraft, disclaimer, risks, legal, MCRT, NFT, cryptocurrency"
        />
        ...
        <meta
          ...
          content="Important disclaimer information about risks and legal obligations when using MagicCraft services."
        />
