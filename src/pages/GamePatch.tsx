      ...
      <Suspense fallback={<div>Loading...</div>}>
        ...
        <main className="scroll-smooth pb-32">
          <section className="relative  md:bg-bgpatch  bg-bgpatch1 bg-contain bg-no-repeat min-h-[90vh] lg:-top-[120px]">
            ...
            <button type="button" onClick={handleScrollTop} aria-label="Scroll to top of page" className="hidden md:block absolute left-4 md:left-20 top-auto md:top-[39em] cursor-pointer z-10"><img src="https://res.cloudinary.com/dfzcr2ch4/image/upload/v1717173152/Go_to_top_of_page_fgfqwp.webp" alt="Scroll to top"/></button>
            <button type="button" onClick={handleOpenSupport} aria-label="Open chat support" className="hidden md:block absolute right-4 md:right-20 top-auto md:top-[35em] cursor-pointer z-10"><img src="https://res.cloudinary.com/dfzcr2ch4/image/upload/v1717173193/Chat_bot_button_a3hguu.webp" alt="Chat support"/></button>
