  ...
  return (
    <>
      <div className="min-h-dvh w-full text-white">
        ...
        <main className="space-y-28 pb-96">
          {/* hero section */}
            ...
            <div className="flex items-start gap-8">
              <div className="w-1/2 space-y-8 self-end">
                ...
                <h4 className="text-2xl leading-9">
                  In 2024, MagicCraft is set to redefine the gaming landscape by
                  positioning MCRT at the heart of every gamer's journey. Our
                  strategic moves and innovations are bridging virtual realms
                  and shaping a unified global gaming economy.
                </h4>
                <div className="flex items-center gap-[10px]">
                  {['MagicCraft', 'Magic 8Ball', 'Magic Runner'].map((val) => {
                    return (
                      <div
                        key={val}
                        ...
                        <div className="grid grid-cols-2 gap-x-3 gap-y-6">
                          <div className="flex items-center gap-2">
                            ...
                            <p className="text-[22px] text-[#C09AFF]">
                              ...
                              Immerse in excellence with enhanced interface for
                              a seamless journey.
                            </p>
                          </div>
                          <div className="flex items-center gap-2">
                            ...
                            <p className="text-[22px] text-[#C09AFF]">
                              ...
                              Engage dynamically with structured milestones and
                              rewards.
                            </p>
                          </div>{' '}
                          <div className="flex items-center gap-2">
